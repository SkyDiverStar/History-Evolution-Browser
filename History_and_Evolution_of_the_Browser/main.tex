...
\clearpage
	...
	\section{History}
		...
		\includegraphics[scale=0.45]{WebBrowserMarketShare.png}
	...
	\section{Evolution}
		...
		By changing the Web, patches also influenced browsers when they were introduced. In this chapter we will have a short summary of what these patches were and how browsers evolved and adpaped through these changes.
			...
			\subsubsection{SSL}
			SSL is the short form for Secure Sockets Layers, which was an introduction of an security system in the internet. One could say that SSL is an application layer based security protocol but that is not entirely true. It actually is used in the session layer which is above the transport layer and beneath the application layer [4]. 
			\subsubsection{CSS}
			\subsubsection{Java}
	...
	%Pic of alexa, firefox vr, eye study 
		...
		\subsubsection{Firefox Reality}
		is a Virtual Reality browser making it possible to access the Web with VR-Glasses. To navigate the voice or a virtual keyboard can be used. The Browser makes it possible to watch 360 degrees videos or pictures and features a collection of games, environments and experiences created for VR. Developers are able to create WebVR Applications themself and upload them to \textit{Firefox Reality}
		\begin{center}
			\includegraphics[scale=0.35]{Firefox_Reality.png}
			[3]	
		\end{center}	%https://blog.mozilla.org/blog/2018/09/18/firefox-reality-now-available/
	...
	\newline
	[4]\url{https://security.stackexchange.com/questions/19681/where-does-ssl-encryption-take-place}
