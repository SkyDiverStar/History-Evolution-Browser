...
\clearpage
	...
	%Pic of alexa, firefox vr, eye study 
		...
		%Screenshot
		Everything that is displayed on the website is an object and can be changed, moved or overwritten. In textfield Javascript code can be executed. 
		%Book, 
		\subsection{Future plans for browsers}
		Firefox Reality
		opera neon
		Supermedium VR Browser
