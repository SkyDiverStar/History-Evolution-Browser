...
\maketitle
	...
	[26]
		...
		\subsection{Next for Browsers}
			Since the introduction of the browser a little and a lot has changed. It gained on speed, performance, security and usability. These attributes with growing in the future as well for sure.
			...
			%TODO:"These attributes with growing in the..." was ist gemeint.%
		 	\begin{center}
